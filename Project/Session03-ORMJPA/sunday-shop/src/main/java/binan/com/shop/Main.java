...
//        deleteFruitById();
    ...
    public static void createCategory(){
        ...
        c1 = new Category("Trai cay nhap khau", "Trai cay nhap khau theo mua");
        Category c2 = new Category();
        c2 = new Category("Trai cay trong nuoc", "Trai cay den tu nha vuon");
        Category c3 = new Category();
        c3 = new Category("Trai cay say kho", "Trai cay say kho det");
...
//        fruit.setName("Zdua Zdua");
    ...
    public static void createFruits(){
        ...
        Fruit cau = new Fruit("MC", "Mãng cầu", "cầu là trái đầu tiên", 5.0);
        Fruit sung = new Fruit("S", "Sung", "Sung là trái 2", 9.0);
        Fruit dua = new Fruit("D", "Dừa", "Dừa là trái 3", 4.0);
